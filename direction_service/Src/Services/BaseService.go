...
type DirectionQueryRequest struct {
	Point []string `form:"point" json:"point" uri:"point" binding:"required"`
}
...
type DirectionQuery struct {
	Points []string `form:"points" json:"points" uri:"points" binding:"required"`
}
